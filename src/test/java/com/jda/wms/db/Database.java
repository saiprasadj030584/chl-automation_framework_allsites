		...
		try {
			...
			if (statusRegion.equalsIgnoreCase("N")) {
				...
				if (region.equalsIgnoreCase("SIT")) {
					...
					/*connection = DriverManager.getConnection(Constants.db_host,Constants.db_user_id,Constants.db_password);
					System.out.println("db-host"+Constants.db_host);
					System.out.println("db-username"+Constants.db_user_id);
