...
System.out.println("dgjfh"+context.getTagId());
...
if (!inventoryTransactionQueryPage.isNoRecords()) {
	...
	public void the_goods_receipt_should_be_generated_for_putaway_idt_stock_in_inventory_transaction() throws Throwable {
