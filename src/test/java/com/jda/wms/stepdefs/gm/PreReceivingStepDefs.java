...
public class PreReceivingStepDefs {
	...
	@Inject
	public PreReceivingStepDefs(PreAdviceHeaderStepsDefs preAdviceHeaderStepsDefs,PreAdviceLineStepDefs preAdviceLineStepDefs,PurchaseOrderReceivingStepDefs purchaseOrderReceivingStepDefs) {
