...
public class PreReceivingStepDefs {
	...
	public PreReceivingStepDefs(PreAdviceHeaderStepsDefs preAdviceHeaderStepsDefs,
			...
			PreAdviceHeaderDB preAdviceHeaderDB,Context context, Verification verification,GetTcData getTcData) {
...
//		String asnId = getTcData.getAsn();
		...
		Assert.assertNotNull("Supplier ID not displayed as expected", preAdviceHeaderDB.getSupplierId(context.getPreAdviceId()));
	}
