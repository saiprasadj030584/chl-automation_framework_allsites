...
public class PreReceivingStepDefs {
	...
	public void the_PO_UPI_ASN_of_type_details_should_be_displayed(String type) throws Throwable {
		...
		Assert.assertNotNull("Supplier ID not displayed as expected",
				preAdviceHeaderDB.getSupplierId(context.getPreAdviceId()));
	}
	...
	public void the_PO_of_type_details_should_be_displayed(String type) throws Throwable {
		preAdviceHeaderStepsDefs.the_PO_of_type_should_be_in_status_with_line_items_supplier_details(type, "Released");
		// Assert.assertNotNull("Supplier ID not displayed as expected",
		// preAdviceHeaderDB.getSupplierId(preAdviceId));
