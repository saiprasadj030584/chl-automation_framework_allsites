...
public class DeliveryManagementStepDefs {
	...
	@Inject
	public DeliveryManagementStepDefs(Context context, JDAFooter jDAFooter,
			 JdaHomePage jDAHomePage,DeliveryDB deliveryDB,DeliveryManagementPage deliveryManagementPage) {
