...
import com.jda.wms.db.Exit.BookingInDiary;
import com.jda.wms.db.Exit.DockSchedulerDB;
import com.jda.wms.db.Exit.MoveTaskDB;
import com.jda.wms.pages.Exit.DockSchedulerBookingsPage;
import com.jda.wms.pages.Exit.DockSchedulerPage;
...
public class DockSchedulerStepDefs {
	...
	public DockSchedulerStepDefs(DockSchedulerPage dockSchedulerPage, JdaHomePage jdaHomePage, JDAFooter jdaFooter,
			...
			Verification verification,JDALoginStepDefs jdaLoginStepDefs,OrderHeaderContext orderHeaderContext,DockSchedulerDB dockSchedulerDB,BookingInDiary bookingInDiary,MoveTaskDB moveTaskDB) {
	...
	public void i_select_booking_type_and_consignment() throws Throwable {
		...
		System.out.println("cons"+context.getSTOConsignment());
		String consignment=moveTaskDB.getconsignment(context.getOrderId());
		dockSchedulerPage.enterConsignment(consignment);
	...
	public void i_select_booking_type_and_a_consignment() throws Throwable {
		...
		Thread.sleep(2000);
		dockSchedulerPage.clickFromSiteId();
		jdaFooter.clickSearch();
		dockSchedulerPage.selectConsignment();
		jdaFooter.clickNextButton();
	}
	...
	@Then("^the booking detail should be deleted in the dock scheduler booking$")
	public void the_booking_detail_should_be_deleted_in_the_dock_scheduler_booking() throws Throwable {
		jdaHomePage.navigateToDockSchedulerBookingsPage();
		jdaFooter.clickQueryButton();
		
		String[] bookingID = context.getDockSchedulerBookingID();
		dockSchedulerBookingsPage.enterBookingID(bookingID[0]);
		jdaFooter.clickExecuteButton();
...
//			 i_search_the_booking_id();
			 i_search_the_first_booking_id();
//			 the_booking_id_details_should_be_displayed();
//			 i_delete_the_booking();
//			 the_booking_detail_should_be_deleted_in_the_dock_scheduler_booking();
		 }
	 }
}
