...
import com.jda.wms.pages.Exit.ClusteringPage;
...
//		Thread.sleep(5000);
	...
	public void i_create_list_ids_manually_in_clustering() throws Throwable {
		...
		i_enter_the_site_id_and_group_id("9771","ALL");
		/* Changed group Id to All because RDC does not support customer "3942"*/
