...
public class SKUMaintenanceTableStepDefs {
	...
	// failureList.add(
	// "SKU Description s not displayed as expected. Expected [Not NULL value]
	// but was [" + skuDesc + "]");
	// }
	...
	// }
	//
	// @Then("^the product group, EAN, UPC, AllocationGroup, each quantity, tag
	// merge fields should be displayed in settings1 tab$")
	// public void
	// the_product_group_EAN_UPC_allocation_group_each_quantity_tag_merge_fields_should_be_displayed_in_settings1_tab()
	// throws Throwable {
	// ArrayList<String> failureList = new ArrayList<String>();
	//
	...
	// failureList.add("Product Group is not displayed as expected. Expected
	// [Not NULL value] but was ["
	// + productGroup + "]");
	// }
	...
	// failureList.add("AllocationGroup is not displayed as expected.Expected
	// [Not NULL value] but was ["
	// + allocationGroup + "]");
	// }
	...
	// context.setEAN(ean);
	// if (ean.equals(null)) {
	// failureList.add("EAN is not displayed as expected. Expected [Not NULL
	// value] but was [" + ean + "]");
	// }
	...
	// if (upc.equals(null)) {
	// failureList.add("UPC is not displayed as expected. Expected [Not NULL
	// value] but was [" + upc + "]");
	// }
	...
	// if (eachQtyInt <= 0) {
	// failureList.add("Each Quantity is not displayed as expected. Expected
	// [>0] but was [" + eachQtyInt + "]");
	// }
	...
	// failureList.add("Tag Merge is not displayed as expected. Expected [Not
	// Checked] but was [Checked]");
	// }
	...
	// Assert.assertTrue("New Product is not displayed as expected. Expected
	// [Checked] but was [Not Checked]",
	// isNewProductChecked);
	...
	// }
	//
	// @Then("^the C&E warehouse type, C&E VAT code, C&E SKU, C&E alcoholic
	// strength fields should be displayed$")
	// public void
	// the_C_E_warehouse_type_C_E_VAT_code_C_E_SKU_C_E_alcoholic_strength_fields_should_be_displayed()
	// throws Throwable {
	// ArrayList<String> failureList = new ArrayList<String>();
	//
	...
	// failureList.add("C&E Warehouse Type is not displayed as expected for BWS.
	// Expected [E] but was ["
	// + cewarehousetype + "]");
	// }
	// } else {
	...
	// failureList
	// .add("C&E Warehouse Type is not displayed as expected for Ambient.
	// Expected [Neither] but was ["
	// + cewarehousetype + "]");
	// }
	// }
	...
	// if (!isCESKUChecked) {
	// failureList
	// .add("C&E SKU is not displayed as expected for BWS. Expected [Checked]
	// but was [Not Checked]");
	// }
	// } else {
	// if (isCESKUChecked) {
	// failureList.add(
	// "C&E SKU is not displayed as expected for Ambient. Expected [Not Checked]
	// but was [Checked]");
	// }
	// }
	...
	// failureList.add("C&E Alcoholic Strength is not displayed as expected.
	...
	// Assert.assertTrue("Site ID is not displayed as expected. Expected [9771]
	// but was [Not 9771]",
	...
	// boolean isExpiryRequiredUnchecked =
	// sKUMaintenancePage.isExpiryRequiredUnchecked();
	// if (context.getAllocationGroup().equalsIgnoreCase("NONEXPIRY")) {
	// Assert.assertTrue("Expiry Required is not displayed as expected. Expected
	// [NOT Checked] but was [Checked]",
	// sKUMaintenancePage.isExpiryRequiredUnchecked());
	// } else if (context.getAllocationGroup().equalsIgnoreCase("EXPIRY")) {
	// Assert.assertFalse("Expiry Required is not displayed as expected.
	// Expected [Checked] but was [Not Checked]",
	// sKUMaintenancePage.isExpiryRequiredUnchecked());
	// }
	...
	// failureList
	// .add("Base UOM is not displayed as expected. Expected [Not NULL value]
	// but was [" + baseUom + "]");
	// }
	...
	// // double sapCreationStatusDouble =
	// // Double.parseDouble(sKUMaintenancePage.getSAPCreationStatus());
	// // int sapCreationStatus = (int) sapCreationStatusDouble;
	// if ((sapCreationStatus != 3) || (sapCreationStatus != 4) ||
	// (sapCreationStatus != 5)
	// || (sapCreationStatus != 6)) {
	// failureList.add("SAP Creation Status is not displayed as expected.
	// Expected [3 or 4 or 5 or 6] but was ["
	// + sapCreationStatus + "]");
	// }
	// Assert.assertTrue(
	...
	public void the_SKU_description_product_group_EAN_UPC_allocation_group_each_quantity_tag_merge_fields_should_be_displayed_in_settings_tab(
		...
		context.setAllocationGroup(skuDB.getAllocatioGroup(context.getSkuId()));
