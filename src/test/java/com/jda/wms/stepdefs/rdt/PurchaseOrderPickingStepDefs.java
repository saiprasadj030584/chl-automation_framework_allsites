...
public class PurchaseOrderPickingStepDefs {
	...
	public PurchaseOrderPickingStepDefs(PurchaseOrderPickingPage purchaseOrderPickingPage, Context context,
			...
			MoveTaskDB moveTaskDB,SchedulerProgramStepDefs schedulerProgramStepDefs,MoveTaskUpdateDB moveTaskUpdateDB, JDAHomeStepDefs jdaHomeStepDefs,
			ClusteringStepDefs clusteringStepDefs,PurchaseOrderVehicleLoadingPage purchaseOrderVehicleLoadingPage,BookingInDiary bookingInDiary,OrderContainerDB orderContainerDB,OrderHeaderDB orderHeaderDB,AddressDB addressDB) {
