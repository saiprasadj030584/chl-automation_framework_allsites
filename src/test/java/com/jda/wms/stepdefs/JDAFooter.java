...
public class JDAFooter {
	...
	public void gn() throws FindFailed, InterruptedException {
		screen.type(Key.F7);
		Thread.sleep(4000);
	}
	...
	public void clickNextButtonImg() throws FindFailed, InterruptedException {
		screen.wait("images/JDAFooter/next.png", timeoutInSec);
