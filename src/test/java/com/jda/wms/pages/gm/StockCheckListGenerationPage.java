...
public class StockCheckListGenerationPage {
	...
	public boolean isListAvailable() {
		if (screen.exists("images/StockCheckListGeneration/AvailableList.png") != null)
			return true;
		else
			return false;
	}
	...
	public void enterquantity(String string) throws FindFailed {
		screen.wait("images/StockCheckListGeneration/TotalQuantity.png", timeoutInSec);
		screen.click("images/StockCheckListGeneration/TotalQuantity.png");
		screen.type("2");
	}

	public void clickMiscelloneousTab() throws FindFailed {
