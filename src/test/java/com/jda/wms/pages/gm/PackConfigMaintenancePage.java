...
public class PackConfigMaintenancePage {
	...
	public void enterTagVolume(String tagVolume) throws FindFailed, InterruptedException {
		Match mTagVolume = screen.find("/images/JDAPackConfig/General/TagVolume.png");
		screen.click(mTagVolume.getCenter().offset(50, 0));
		screen.type(tagVolume);
		Thread.sleep(1000);
	}
	
	public void enterTrackingLevel(String trackingLevel) throws FindFailed, InterruptedException {
		Match mTagVolume = screen.find("/images/JDAPackConfig/Tracking Level/TrackingLevel1.png");
		screen.click(mTagVolume.getCenter().offset(70, 0));
		screen.type(trackingLevel);
		Thread.sleep(1000);
	}
	public void clickRDTDisplayLevel1() throws FindFailed, InterruptedException {
		screen.wait("/images/JDAPackConfig/RDT/RDTDisplayLevel1.png", timeoutInSec);
		screen.click("/images/JDAPackConfig/RDT/RDTDisplayLevel1.png");
		Thread.sleep(2000);
	}
	...
	public boolean isRecordAlreadyExists() throws FindFailed, InterruptedException {
		if (!screen.exists("/images/JDAPackConfig/RecordExistsError.png").equals(null)) {
			return true;
		} else
			return false;
	}
