...
public class OrderPreparationPage {
	...
	public void enterGroupType() throws FindFailed {
		screen.wait("images/OrderPreparation/GroupType.png", timeoutInSec);
		screen.click("images/OrderPreparation/GroupType.png");
		screen.type("Consignment");
	}

	public void enterOrderId(String orderId) throws FindFailed {
		screen.wait("images/OrderPreparation/Order.png", timeoutInSec);
		screen.click("images/OrderPreparation/Order.png");
		screen.type(orderId);
	}
