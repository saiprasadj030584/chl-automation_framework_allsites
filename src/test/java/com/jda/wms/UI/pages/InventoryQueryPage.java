...
public class InventoryQueryPage {
	...
	public InventoryQueryPage(Context context, JDAFooter jDAFooter) {
	...
	private void clickABV() throws FindFailed, InterruptedException {
		jDAFooter.clickQueryButton();
		screen.type(context.getTagId());
		jDAFooter.clickExecuteButton();
		eitherSingleOrMultipleTagId();
		clickUserDefinedTab();
		Thread.sleep(3000);
