...
public class InventoryTransactionQueryPage {
	...
	@Inject
	public InventoryTransactionQueryPage(JDAFooter jdaFooter,JdaHomePage imageCheckFunction) {
...
//		screen.click("/images/InventoryTransactionQuery/TransactionDate.png");
	...
	public String getUpdateQty() throws FindFailed, InterruptedException {
		
		if (screen.exists("/images/InventoryTransactionQuery/General/UpdateQty.png") != null) {
			...
			//commented by Bhuban
			/*imageCheckFunction
					.checkImageOnScreenAndClickTheGivenImageObject("/images/InventoryTransactionQuery/MultipleCodeList.png", 1.0f);*/
			//below 2 lines added by Bhuban
			Match matchCode = screen.find("/images/InventoryTransactionQuery/Tagidsort.png");
			screen.click(matchCode.getCenter());
			Match mCode = screen.find("/images/InventoryTransactionQuery/MultipleCodeList.png");
			screen.doubleClick(mCode.below(10));
			Thread.sleep(2000);
			if (screen.exists("images/InventoryTransactionQuery/General/UpdateQty.png") != null) {
				Match updQty = screen.find("/images/InventoryTransactionQuery/General/UpdateQty.png");
				screen.click(updQty.getCenter().offset(70, 0));
				screen.type("a", Key.CTRL);
				screen.type("c", Key.CTRL);

			} else {
				System.out.println("multiple list not found");
			}
		}
		return App.getClipboard();
	...
	public void eitherSingleOrMultipleTagId() throws FindFailed, InterruptedException {
		Thread.sleep(3000);
		if (screen.exists("/images/InventoryQuery/SingleTagId.png") != null) {
			Match mKitId = screen.find("/images/InventoryQuery/SingleTagId.png");
			screen.click(mKitId.getCenter().offset(70, 0));

		} else if (screen.exists("/images/InventoryQuery/TableTagId.png") != null) {
			Match mKitId1 = screen.find("/images/InventoryQuery/TableTagId.png");
			screen.wait("/images/InventoryQuery/TableTagId.png", timeoutInSec);
			screen.click("/images/InventoryQuery/TableTagId.png");
			screen.doubleClick(mKitId1.below(10));
			Thread.sleep(2000);
			if (screen.exists("/images/InventoryQuery/SingleTagId.png") != null) {
				Match mKitId = screen.find("/images/InventoryQuery/SingleTagId.png");
				screen.click(mKitId.getCenter().offset(70, 0));
	...
	public String getReasonCodeNew() throws FindFailed {
		Match mStatus = screen.find("images/InventoryTransactionQuery/Miscellaneous/NewPackConfig.png");
		screen.click(mStatus.getCenter().offset(70, 0));
		screen.type("a", Key.CTRL);
		screen.type("c", Key.CTRL);
		return App.getClipboard();
	...
	public void enterTransactionTime(String TransactionTime)  throws FindFailed, InterruptedException {
		Thread.sleep(3000);
		System.out.println("transacton time"+TransactionTime);
		Match mLocation = screen.find("images/MoveTaskQuery/Time.png");
		screen.click(mLocation.getCenter().offset(70, 0));	
		screen.type(">"+TransactionTime);
		screen.type(Key.ENTER);
	}
