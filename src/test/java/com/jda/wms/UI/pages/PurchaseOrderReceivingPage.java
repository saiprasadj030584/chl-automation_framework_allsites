...
public class PurchaseOrderReceivingPage<EnterPalletID> {
	...
	public void selectvehicleUnloadMenu() throws FindFailed, InterruptedException {
		screen.type("2");
		Thread.sleep(1000);
		screen.type(Key.ENTER);
		Thread.sleep(2000);
...
//		String prefixlist=StringUtils.substring(actualUPC, 0, 4);
	...
	public void EnterPalletIDBliRcv(String palletID) throws InterruptedException {
		screen.type(palletID);
		Thread.sleep(1000);
		//screen.type(Key.TAB);
	}
	...
	public void EnterUPCblircv(String UPC) throws InterruptedException {
		screen.type(UPC);
		Thread.sleep(1000);
		screen.type(Key.TAB);
			}
