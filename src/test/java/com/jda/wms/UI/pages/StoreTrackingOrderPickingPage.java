...
public class StoreTrackingOrderPickingPage {
	...
	public void selectMarshal() throws InterruptedException {
		Thread.sleep(2000);
		screen.type("6");
		Thread.sleep(1000);
		screen.type(Key.ENTER);
	...
	public void selectAsstRtn() throws InterruptedException {
		Thread.sleep(2000);
		screen.type("8");
		Thread.sleep(1000);
		screen.type(Key.ENTER);
	...
	public void selectRpkScreen() throws InterruptedException {
		Thread.sleep(2000);
		screen.type("3");
		Thread.sleep(1000);
		screen.type(Key.ENTER);
	...
	public boolean isMarshalDisplayed() {
		if (screen.exists("images/Putty/MarEnt.png") != null)
			return true;
		else
			return false;
	}
	public boolean isAsstRtnDisplayed() {
		if (screen.exists("images/Putty/AsstRtn.png") != null)
			return true;
		else
			return false;
	}
	public boolean isRpkEntDisplayed() {
		if (screen.exists("images/Putty/RepackEntryPage.png") != null)
			return true;
		else
			return false;
	}
	public boolean isPalRpkFromCDisplayed() {
		if (screen.exists("images/Putty/PalRpkFrmC.png") != null)
			return true;
		else
			return false;
	}
	public boolean isMarshalCmpDisplayed() {
		if (screen.exists("images/Putty/MarCmp.png") != null)
			return true;
		else
			return false;
	}
	public boolean isCmpTaskDisplayed() {
		if (screen.exists("images/Putty/CompTask.png") != null)
			return true;
		else
			return false;
	}
	...
	public void enterMarshalPallet(String pallet) throws InterruptedException {
		screen.type(Key.TAB);
		screen.type(pallet);
		Thread.sleep(1000);
	}
	public void enterPallet(String pallet) throws InterruptedException {
		screen.type(pallet);
		Thread.sleep(1000);
	}
