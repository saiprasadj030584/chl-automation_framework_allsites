...
@JsonPropertyOrder({ "type", "pincodes", "state", "country", "city", "slavepriority", "sellercode", "productName",
		"pinCode", "stateCode", "countryName", "placeName", "slavePriority", "tatCode", "tataPriority" })
