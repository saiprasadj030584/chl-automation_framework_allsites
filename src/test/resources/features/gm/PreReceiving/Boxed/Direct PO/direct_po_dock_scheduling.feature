...
Feature: Dock Scheduling
  ...
  @pre_receiving @direct_po @boxed @boxed_pre_receiving_direct_po_delete_booking_asn_direct_po @complete
  ...
  @pre_receiving @direct_po @boxed @boxed_pre_receiving_direct_po_move_booking_diff_time_sameday_asn_direct_po @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - Direct PO
    Given I have done the dock scheduler booking with the PO "<PreAdviceID>", UPI "<UPIId>", ASN "<ASNId>" of type "<DataType>" at site "<SiteId>"
    When I navigate to dock scheduler start page
    When I select view existing bookings
  ...
  @pre_receiving @direct_po @boxed @boxed_pre_receiving_direct_po_change_status_of_booking_to_complete_asn_direct_po @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - Direct PO
    Given I have done the dock scheduler booking with the PO "<PreAdviceID>", UPI "<UPIId>", ASN "<ASNId>" of type "<DataType>" at site "<SiteId>"
    When I navigate to dock scheduler start page
    When I select view existing bookings
