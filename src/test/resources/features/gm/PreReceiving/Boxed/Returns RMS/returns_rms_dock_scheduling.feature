...
Feature: Dock Scheduling
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scehduling_returns_rms @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - returns RMS 
    ...
    Examples: 
      ...
      @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scehduling_carrier_info @complete
  Scenario Outline: Validate whether Booking details can be captured - Carrier Information
    ...
    Examples: 
      ...
      @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scehduling_service_level_info @complete
  Scenario Outline: Validate whether Booking details can be captured - Service level information
    ...
    Examples: 
      ...
      @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scehduling_trailer_type_info @complete
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_delete_booking_returns_RMS @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - returns RMS
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_move_booking_diff_time_sameday_returns_RMS @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - returns RMS
    Given I have done the dock scheduler booking with the UPI "<UPIId>", ASN "<ASNId>" of type "<DataType>" at site "<SiteId>"
    When I navigate to dock scheduler start page
    When I select view existing bookings
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_change_status_of_booking_to_complete_returns_RMS @complete
  Scenario Outline: Validate whether ASN can be assigned using the Container ID - returns RMS
    Given I have done the dock scheduler booking with the UPI "<UPIId>", ASN "<ASNId>" of type "<DataType>" at site "<SiteId>"
    When I navigate to dock scheduler start page
    When I select view existing bookings
