@purchase_order
Feature: Purchase order over receiving with LOck code
  As a warehouse user
  I want to receive more locked articles
  But i cannot putaway the purchase order

  @over receiving_articles_with_lock_code
  Scenario Outline: Purchase order over receiving with Lock code for hanging types articls
