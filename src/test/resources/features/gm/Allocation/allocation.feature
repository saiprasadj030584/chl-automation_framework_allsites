...
Feature: Allocation
  ...
  @allocation @retail @boxed @boxed_allocation_retail_stock_in_suspense_location_not_allocated @review
  ...
  @allocation @international @boxed @boxed_allocation_international_stocks_allocation_international_allocation_rules @review
  ...
  @allocation @retail @boxed @boxed_allocation_retail_stocks_allocation_retail_allocation_rules @review
  ...
  @allocation @retail @boxed @boxed_allocation_retail_stocks_allocation_just_in_time_allocation @review
  ...
  @allocation @idt @boxed @boxed_allocation_idt_stocks_allocation_just_in_time_allocation @review
  Scenario Outline: Validate whether stocks are allocated to orders  -Just in Time Allocation
