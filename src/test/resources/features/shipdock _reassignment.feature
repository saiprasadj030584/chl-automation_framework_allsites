...
@complete @sto @shipdock_reassignment
  Scenario Outline: Shipdock reassignment
    Given I have logged in as warehouse user in JDA dispatcher food application
    When I navigate to ship dock reassignment
    And I enter the from site id "9771" and order id "<OrderID>"
