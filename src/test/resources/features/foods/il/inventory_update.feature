...
Feature: Inventory update
  ...
  Scenario: Inventory expiry date update
    ...
    And the inventory should be expired for a SKU id and with qty on hand more than allocated qty for the tag
    When I navigate to inventory update page
    And I select the type of invetnotry status as "Expiry Date Update"
    When I navigate to search tab
    And I search the tag id
    ...
    And I select the code as "Expiry Update" and enter the tag id
  ...
  Scenario: To update the ABV through Inventory table in JDA WMS dispatcher
    ...
    And I have SKU id, product group and ABV for the tag id
    When I navigate to inventory update page
    ...
    When I navigate to inventory transaction query
    And I search tag id with transaction code as "User Defined Update"
