...
Feature: Boxed - IDT - Allocation
  ...
  @allocation @idt @boxed @unique_boxed_allocation_idt_validate_whether_the_stock_in_suspense_location_is_not_allocated_non_allocation @complete @ds
  ...
  @boxed @allocation @idt @unique_boxed_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds
  ...
  @allocation @boxed @idt @unique_boxed_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_prioritize @complete @ds
 ...
 @jenkinsA @jenkins1 @boxed @allocation @idt @unique_boxed_allocation_idt_validate_whether_stocks_are_automatically_allocated_to_orders_auto_allocation @complete @ds
  ...
  @jenkinsA  @jenkins1 @unique_boxed_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @boxed @complete @ds
