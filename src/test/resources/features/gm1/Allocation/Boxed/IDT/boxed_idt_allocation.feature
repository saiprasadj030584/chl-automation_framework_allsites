...
Feature: Boxed - IDT - Allocation
  ...
  I want to perform allocation of stocks
     ...
     @r1 @jenkinsA  @allocation @yes @idt @boxed @unique_boxed_allocation_idt_validate_whether_the_stock_in_suspense_location_is_not_allocated_non_allocation @complete @ds
  Scenario: Validate whether the stock in suspense location is not allocated-Non allocation
   ...
   @r1 @jenkinsA @boxed @allocation @idt @unique_boxed_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds
  ...
  @r1 @jenkinsA @allocation @boxed @idt @unique_boxed_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_prioritize @complete @ds
  ...
  @r1 @jenkinsA @allocation @boxed @idt @unique_boxed_allocation_idt_validate_whether_order_is_available_for_allocation @complete @ds
  Scenario: Validate whether stock is available for allocation
    Given the OrderID of type "IDT" should be in "Released" status at site
    And I have inventory available for the order line items
    Then sku should be available in inventory

 @r1 @jenkinsA  @jenkinsgm @jenkinsgm1 @boxed @allocation @idt @unique_boxed_allocation_idt_validate_whether_stocks_are_automatically_allocated_to_orders_auto_allocation @complete @ds
 ...
 @r1 @jenkinsA @jenkinsgm @jenkinsgm1 @unique_boxed_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @boxed @complete @ds
 ...
 @r1  @jenkinsic  @allocation @idt @boxed @unique_boxed_allocation_idt_validate_whether_stock_with_earliest_expiry_date_is_allocated_first_expiry_date_sensitive_product @complete @ds 
