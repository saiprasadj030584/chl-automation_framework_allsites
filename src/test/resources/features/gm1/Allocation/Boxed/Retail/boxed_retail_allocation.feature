...
Feature: Boxed - Retail - Allocation
  ...
  @jenkinsA @unique_boxed_allocation_retail_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @retail @boxed @complete @ds
