...
Feature: Boxed - Retail - Allocation
  ...
  I want to perform allocation of stocks
   ...
   @r1 @jenkinsA @yes @allocation @retail @boxed @unique_boxed_allocation_retail_validate_whether_the_stock_in_suspense_location_is_not_allocated_non_allocation @complete @ds
...
@r1  @jenkinsA @allocation @retail @boxed @unique_boxed_allocation_retail_validate_whether_all_the_stocks_are_allocated_allocation_rules_retail_orders @complete @ds
 ...
 @r1  @jenkinsA @boxed @allocation @retail @unique_boxed_allocation_retail_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds
  ...
  @r1  @jenkinsA @yes @allocation @retail @boxed @unique_boxed_allocation_retail_stocks_allocation_just_in_time_allocation @onhold @ds
 ...
 @r1 @jenkinsA @allocation @boxed @retail @unique_boxed_allocation_retail_validate_prohibition_rule @complete @ds
 ...
 @r1  @jenkinsA  @allocation @boxed @retail @unique_boxed_allocation_retail_validate_whether_order_is_available_for_allocation @complete @ds
  Scenario: Validate whether stock is available for allocation
    Given the OrderID of type "Retail" should be in "Released" status at site
    And I have inventory available for the order line items
    Then sku should be available in inventory

 @r1 @jenkinsA @boxed @allocation @retail @unique_boxed_allocation_retail_validate_whether_stocks_are_automatically_allocated_to_orders_auto_allocation @complete @ds
...
@r1  @jenkinsA @jenkinsgm @jenkinsgm1 @unique_boxed_allocation_retail_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @retail @boxed @complete @ds
  ...
  @r1  @jenkinsic @allocation @retail @boxed @unique_boxed_allocation_retail_validate_whether_stock_with_earliest_expiry_date_is_allocated_first_expiry_date_sensitive_product @complete @ds 
