...
Feature: Boxed - International - Allocation
  ...
  I want to perform allocation of stocks
   ...
   @jenkinsp @allocation @international @unique_boxed @boxed_allocation_international_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds 
