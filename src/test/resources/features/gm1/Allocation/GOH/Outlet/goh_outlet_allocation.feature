...
Feature: Boxed - Outlet - Allocation
 ...
 @r1  @jenkinsC @jenkinsgm @jenkins14 @allocation @outlet @goh @unique_goh_allocation_outlet_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds @jenkall
