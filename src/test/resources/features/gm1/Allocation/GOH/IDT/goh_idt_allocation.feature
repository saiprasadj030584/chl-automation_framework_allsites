...
Feature: GOH - IDT - Allocation
  ...
  Scenario: Validate the Prohibition Rules while allocating the stock  -Prohibition Rules -Prioritize
    ...
    @jenkinsC @allocation @goh @idt @goh_allocation_idt_validate_whether_order_is_available_for_allocation @complete @ds
  ...
  @jenkinsC @goh_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @goh @complete @ds
