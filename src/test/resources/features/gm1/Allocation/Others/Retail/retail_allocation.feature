...
Feature: Allocation
  ...
  @allocation @retail @goh @goh_allocation_retail_allocation_rules @complete @new_script
  ...
  @retail_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @retail @goh @complete  @new_script
  ...
  @allocation @retail @goh @goh_allocation_retail_consolidate_orders @complete @new_script
