...
Feature: Allocation
  ...
  @goh_allocation_retail_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @retail @goh @complete @stock_vis @retail_check
  ...
  @allocation @retail @goh @goh_allocation_retail_validate_whether_different_orders_of_same_store_are_grouped_together_for_one_pick_consolidate_orders @complete @new_script @retail_check @consolidate_check
  ...
  @yes @allocation @retail @goh @goh_allocation_retail_validate_whether_the_stock_in_suspense_location_is_not_allocated_non_allocation @complete @retail_check @suspense_check
