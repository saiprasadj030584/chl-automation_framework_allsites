...
Feature: Boxed - International - Allocation
  ...
  @allocation  @jenkinsC @international @goh @goh_allocation_international_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @allocation7_check
