...
Feature: Boxed - ECom - Allocation
  ...
  I want to perform allocation of stocks
      ...
      @jenkinsC @jenkinsgm @jenkins14 @allocation @e_com @boxed @unique_boxed_allocation_e_com_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds @ecum
