...
Feature: Allocation
  ...
  @jenkinsC @allocation @idt @goh @goh_allocation_idt_validate_whether_the_stock_in_suspense_location_is_not_allocated_non_allocation @complete @suspense_check
  Scenario: Validate whether the stock in suspense location is not allocated-Non allocation
   ...
   @jenkinsC @goh_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @goh @complete @stock_vis
  ...
  @yes  @jenkinsC  @allocation @idt @goh @goh_allocation_idt_validate_whether_different_orders_of_same_store_are_grouped_together_for_one_pick_consolidate_orders @complete @new_script @consolidate_check
  Scenario: Validate whether different orders of  same store are grouped together for one pick -  Consolidate Orders
    ...
    And the orders should get consolidated
     ...
     @yes  @jenkinsC  @allocation @idt @goh @goh_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds @gems
