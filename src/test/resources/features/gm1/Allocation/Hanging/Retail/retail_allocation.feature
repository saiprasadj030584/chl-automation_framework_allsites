...
Feature: Allocation
 ...
 @r1 @yes @jenkinsB  @allocation @retail @hanging @hanging_allocation_retail_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds @gems
  Scenario: Validate the Prohibition Rules while allocating the stock  -Prohibition Rules -Disallowed 
    ...
    Then the stock should not get allocated
     ...
     @r1  @jenkinsB @allocation @retail @hanging @unique_hanging_allocation_retail_validate_whether_different_orders_of_same_store_are_grouped_together_for_one_pick_consolidate_orders @complete 
