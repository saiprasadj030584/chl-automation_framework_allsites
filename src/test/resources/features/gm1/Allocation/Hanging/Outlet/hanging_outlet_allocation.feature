...
@r1  @allocation @outlet @hanging @unique_hanging_allocation_outlet_stock_in_suspense_location_not_allocated @review
  Scenario Outline: Validate whether the stock in suspense location is not allocated-Non allocation
    ...
    Examples: 
     ...
     @jenkinsB @allocation @outlet @hanging @unique_hanging_allocation_outlet_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds 
