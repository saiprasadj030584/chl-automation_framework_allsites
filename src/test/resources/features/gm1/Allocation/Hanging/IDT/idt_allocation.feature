...
Feature: Allocation
  ...
  I want to perform allocation of stocks
   ...
   @jenkinsB @allocation @idt @hanging @unique_hanging_allocation_idt_stock_in_suspense_location_not_allocated @complete
  Scenario: Validate whether the stock in suspense location is not allocated-Non allocation
    ...
    @jenkinsB @yes @allocation @idt @hanging @unique_hanging_allocation_idt_validate_whether_different_orders_of_same_store_are_grouped_together_for_one_pick_consolidate_orders @complete
  Scenario: Validate whether different orders of  same store are grouped together for one pick -  Consolidate Orders
    ...
    @jenkinsB @allocation @idt @hanging @hanging_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds @gems
