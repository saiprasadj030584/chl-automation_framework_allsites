...
Feature: Allocation
 ...
 @r1  @jenkinsB @allocation @idt @hanging @unique_hanging_allocation_idt_stock_in_suspense_location_not_allocated @complete
  ...
  @r1  @jenkinsB @yes @allocation @idt @hanging @unique_hanging_allocation_idt_validate_whether_different_orders_of_same_store_are_grouped_together_for_one_pick_consolidate_orders @complete
 ...
 @r1   @jenkinsB @allocation @idt @hanging @hanging_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_disallowed @complete @ds @gems
