...
@r1 @jenkinsB @hanging @allocation @idt @unique_hanging_allocation_idt_validate_whether_stocks_are_automatically_allocated_to_orders_auto_allocation @complete @ds
 ...
 @r1 @jenkinsB  @allocation @hanging @idt @unique_hanging_allocation_idt_validate_the_prohibition_rules_while_allocating_the_stock_prohibition_rules_prioritize @complete @ds
  Scenario: Validating prohibition rule while allocation
   ...
   @r1  @jenkinsB @allocation @hanging @idt @unique_hanging_allocation_idt_validate_whether_order_is_available_for_allocation @complete @ds
  Scenario: Validating availability of stock for allocation
    Given the OrderID of type "IDT" for sku "Hanging" should be in "Released" status at site
    And I have inventory available for the order line items
    Then sku should be available in inventory

@r1  @jenkinsB @unique_hanging_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @hanging @complete @ds
