...
Feature: Hanging - IDT - Allocation
  ...
  @hanging @allocation @idt @unique_hanging_allocation_idt_validate_whether_stocks_are_automatically_allocated_to_orders_auto_allocation @complete @ds
  ...
  @jenkinsB @unique_hanging_allocation_idt_validate_whether_there_is_visibility_in_stock_modularity_for_ordering_visiblity_of_stock_types_for_ordering @allocation @idt @hanging @complete @ds
