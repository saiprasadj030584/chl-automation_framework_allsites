...
Feature: Hanging - International - Allocation
  ...
  I want to perform allocation of stocks
   ...
   @jenkinsta @allocation @international @hanging @hanging_allocation_international_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds 
