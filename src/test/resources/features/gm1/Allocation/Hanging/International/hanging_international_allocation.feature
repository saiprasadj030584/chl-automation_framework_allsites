...
Feature: Hanging - International - Allocation
  ...
  I want to perform allocation of stocks
   ...
   @jenkinsB @allocation @international @hanging @unique_hanging_allocation_international_validate_whether_all_the_stocks_are_allocated_allocation_rules @complete @ds 
