...
Feature: Boxed - Returns - Putaway
  ...
  @boxed @putaway @returns @unique_boxed_putaway_returns_validate_mezz/shelving_putaway @complete @ds
  ...
  @boxed @putaway @returns @unique_boxed_putaway_returns_validate_returns_putaway_type @complete @ds
  ...
  @unique_boxed_putaway_returns_validate_putaway_location @returns @complete @putaway @boxed @ds
  ...
  @unique_boxed_putaway_returns_validate_putaway_quantity @returns @complete @putaway @boxed @ds
  ...
  @unique_boxed_putaway_returns_validate_returns_putaway_to_preferred_aisle @returns @boxed @putaway @complete @ds
  ...
  @unique_boxed_putaway_returns_validate_override_putaway_location @boxed @returns @putaway @complete @ds
