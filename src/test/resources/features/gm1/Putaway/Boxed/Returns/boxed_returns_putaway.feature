...
Feature: Boxed - Returns - Putaway
  ...
  @boxed @putaway @returns @unique_boxed_putaway_returns_validate_mezz/shelving_putaway @complete1 @ds
  ...
  @boxed @putaway @returns @unique_boxed_putaway_returns_validate_returns_putaway_type @complete1 @ds
  ...
  @unique_boxed_putaway_returns_validate_putaway_location @returns @complete1 @putaway @boxed @ds
  ...
  @unique_boxed_putaway_returns_validate_putaway_quantity @returns @complete1 @putaway @boxed @ds
  ...
  @unique_boxed_putaway_returns_validate_returns_putaway_to_preferred_aisle @returns @boxed @putaway @complete1 @ds
  ...
  @unique_boxed_putaway_returns_validate_override_putaway_location @boxed @returns @putaway @complete1 @ds
  ...
  @unique_returns_boxed_putaway_location_full @boxed @returns @boxed @putaway @onhold
  ...
  @boxed @putaway @returns @unique_boxed_putaway_returns_validate_putaway_qc_goods @complete1 @ds
  ...
  @yes @boxed @putaway @returns @unique_boxed_putaway_returns_validate_maximum_locations_per_aisle_per_upc @ds @complete1 
