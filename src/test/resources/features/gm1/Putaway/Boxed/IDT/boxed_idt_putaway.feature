...
Feature: Boxed - IDT - Putaway
  ...
  @boxed @putaway @idt @unique_boxed_putaway_idt_validate_mezz/shelving_putaway @complete @ds
  ...
  @unique_boxed_putaway_idt_validate_putaway_quantity @boxed @putaway @idt @complete @ds 
  ...
  @unique_boxed_putaway_idt_validate_putaway_location @boxed @putaway @idt @complete @ds 
  ...
  @unique_boxed_putaway_idt_validate_putaway_logic_for_receiving_singles_when_locations_full @boxed @idt @putaway @compete @ds 
  ...
  @unique_boxed_putaway_idt_validate_override_putaway_location @boxed @idt @putaway @compete @ds 
  ...
  @boxed @putaway @idt @unique_boxed_putaway_idt_validate_putaway_process @complete @ds
  ...
  @boxed @putaway @idt @unique_boxed_putaway_idt_validate_hazardous_putaway_location @complete @ds
  Scenario Outline: Validate Hazardous Putaway location
    ...
    @yes @boxed @putaway @idt @boxed_putaway_idt_validate_maximum_locations_per_aisle_per_upc @complete @ds @max
