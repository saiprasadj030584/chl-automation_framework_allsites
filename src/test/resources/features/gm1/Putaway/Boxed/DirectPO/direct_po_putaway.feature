...
Feature: Purchase order Putaway
  ...
  @boxed_putaway_direct_po_validate_putaway_location @direct_po @complete @putaway @boxed @ds
  ...
  @boxed_putaway_direct_po_validate_putaway_quantity @direct_po @complete @putaway @boxed @ds
