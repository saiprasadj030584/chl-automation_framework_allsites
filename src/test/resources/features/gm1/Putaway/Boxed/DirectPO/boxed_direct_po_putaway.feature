...
Feature: Purchase order Putaway
  ...
  @jenkins_analysis @boxed @putaway @direct_po @boxed_putaway_direct_po_validate_sampling/qa_pallet_build @complete @ds @maven_check_1 @putty_check @maven_check_2
