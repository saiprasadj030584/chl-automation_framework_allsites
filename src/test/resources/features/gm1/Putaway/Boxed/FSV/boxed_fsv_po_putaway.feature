...
Feature: Purchase order Putaway
  ...
  @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_mezz/shelving_putaway @complete @ds @jenkinsput
  ...
  @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_sampling/qa_pallet_build @complete @ds @jenkinsput
  ...
  @boxed_putaway_fsv_po_validate_override_putaway_location @boxed @fsv_po @putaway @compete @ds @jenkinsput
  ...
  @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_putaway_process @complete @ds @boxed_jenkins @jenkinsput
  ...
  @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_putaway_qc_goods @complete @ds @jenkinsput
  ...
  @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_hazardous_putaway_location @complete @ds @jenkinsput
