...
Feature: Purchase order Putaway
  ...
  Scenario: Validate Override Putaway Location
    ...
    @boxed @putaway @fsv_po @boxed_putaway_fsv_po_validate_putaway_process @complete @ds
  Scenario: Validate Putaway Process
    ...
    @boxed @putaway @fsv_po @boxed_putaway_idt_validate_putaway_qc_goods @complete @ds
