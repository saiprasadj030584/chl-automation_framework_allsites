...
Feature: Boxed - Retail - Validate Part Set products
  ...
  @unique_boxed_picking_picking_validate_multi_part_setwarning_is_displayed_when_picking_the_part_set_product @picking @boxed @complete @retail @ds
  ...
  @unique_boxed_picking_picking_validate_multi_part_set_instructions_is_displayed_when_picking_the_part_set_product @picking @boxed @complete @retail @ds
