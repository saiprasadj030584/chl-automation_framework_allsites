...
Feature: Picking
  ...
  @boxed_picking_picking_validate_multi_part_set_warning @picking @boxed @complete
  ...
  @boxed_picking_picking_validate_multi_part_set_instruction @picking @boxed @complete
