...
Feature: Flatpack - Picking - Retail - Auto clustering
  ...
  @unique_flatpack_picking_retail_validate_whether_auto_clustering_process_is_done_after_the_allocation_process @jenkinsC @flatpack @picking @retail @ds @complete
