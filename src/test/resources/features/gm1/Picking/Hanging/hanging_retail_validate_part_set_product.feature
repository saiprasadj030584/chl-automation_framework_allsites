@boxed_picking_retail_validate_part_set
Feature: Boxed - Retail - Validate Part Set products
  As a warehouse user
  I want to receive the returned articles

  @unique_hanging_picking_picking_validate_multi_part_setwarning_is_displayed_when_picking_the_part_set_product @picking @boxed @complete @retail @ds
  Scenario: Validate Multi Part setWarning is displayed when picking the part set product
    ...
    When I perform picking for "Hanging"
    Then the part set warning should be displayed
    And the picking should be completed
    
  @unique_hanging_picking_picking_validate_multi_part_set_instructions_is_displayed_when_picking_the_part_set_product @picking @boxed @complete @retail @ds
