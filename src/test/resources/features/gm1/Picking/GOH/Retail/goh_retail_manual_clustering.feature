@goh_picking_retail_manual_clustering
Feature: GOH - Retail - Manual Clustering
  As a warehouse user
  I want to perform manual clustering

   @jenkinsac @goh @picking @retail @goh_picking_retail_validate_whether_clustering_is_done_manually @complete @ds
