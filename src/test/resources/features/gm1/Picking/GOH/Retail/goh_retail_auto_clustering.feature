@goh_picking_auto_clustering
Feature: GOH - Picking - Retail - Auto clustering
  As a warehouse user
  I want to validate the auto clustering 
  So that the generated list id can be used for picking

   @jenkinsC @unique_goh_picking_retail_validate_whether_auto_clustering_process_is_done_after_the_allocation_process @goh @picking @retail @ds @complete
