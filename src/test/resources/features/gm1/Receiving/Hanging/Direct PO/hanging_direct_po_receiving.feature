...
Feature: Hanging - Direct PO - Receiving
  ...
  @jenkinsB @unique_hanging_receiving_direct_po_trailer_level_discrepancy @hanging @receiving @direct_po @complete @ds @no_ds
  Scenario: Trailer level discrepancy
    ...
    Then the trailor level discrepancy report should be generated
     ...
     @jenkinsB @jenkns @unique_hanging_receiving_direct_po_validate_automatic_document_closure_asn @receiving @direct_po @boxed @complete @ds @jenkinsbr
 ...
 @jenkinsB @unique_hanging_receiving_direct_po_validate_manual_receipt @hanging @receiving @direct_po @complete @ds @jenkinsrun
  ...
  Scenario: Perform receiving when Pre advice line quantity is lesser than the UPI line quantity
   ...
   @jenkinsB @unique_hanging_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_greater_than_the_upi_line_quantity @po @complete @boxed @receiving @direct_po @ds
  ...
  Scenario: Validate receipting process without lock code
    ...
    @jenkinsB @unique_hanging_receiving_direct_po_validate_the_urgent_delivery_po @hanging @direct_po @receiving @complete @ds
