...
Feature: Boxed - Returns - Receiving - PartSet
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_part_in_set_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_part_in_set_is_2_perfect_condition_as_y_ @receiving @returns @boxed @complete1 @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_part_in_set_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_part_in_set_is_2_perfect_condition_as_n_–_dmg_lock_code_in_itl @receiving @returns @boxed @complete1 @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_part_in_set_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_part_in_set_is_1_perfect_condition_as_y_impset_lock_code_in_itl @receiving @returns @boxed @complete1 @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_part_in_set_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_part_in_set_is_1_perfect_condition_as_n_impset_lock_code_in_itl @receiving @returns @boxed @complete1 @ds
