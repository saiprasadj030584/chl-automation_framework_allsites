...
Feature: Boxed - Returns - Receiving - Negative validations
  ...
  @unique_boxed_receiving_returns_verify_quantity_field_by_providing_different_input_in_the_blind_receiving_screen @returns @boxed @receiving @complete1 @ds
  ...
  @jenkinsA @stoke @unique_boxed_receiving_returns_urrn_entered_in_the_receiving_screen_which_is_not_in_the_system_negative_test @returns @boxed @receiving @complete1 @ds @no_ds
