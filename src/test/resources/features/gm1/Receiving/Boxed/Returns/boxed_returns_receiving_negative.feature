...
Feature: Boxed - Returns - Receiving - Negative validations
  ...
  @jenkinsA @boxed_receiving_returns_urrn_entered_in_the_receiving_screen_which_is_not_in_the_system_negative_test @returns @boxed @receiving @complete @ds @no_ds
