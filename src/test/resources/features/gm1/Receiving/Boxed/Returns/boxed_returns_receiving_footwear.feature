...
Feature: Boxed - Returns - Receiving - Footwear
  ...
  @boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_–_dmg_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_both_have_same_suffix]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_–_imperfect_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_only_one_value_provided]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_–_singleshoe_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_only_one_value_provided]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_ singleshoe_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_–_should_prompt_to_provide_correct_upc_as_10_digit @receiving @returns @boxed @complete @ds
