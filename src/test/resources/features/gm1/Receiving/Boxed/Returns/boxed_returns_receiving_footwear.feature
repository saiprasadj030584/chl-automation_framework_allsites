...
Feature: Boxed - Returns - Receiving - Footwear
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_dmg_lock_code_in_itl @receiving10 @returns @boxed @complete @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_both_have_same_suffix]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_imperfect_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_both_have_same_suffix]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_imperfect_lock_code_in_itl @receiving @returns @boxed @complete @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_only_one_value_provided]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_singleshoe_lock_code_in_itl @receiving @returns @boxed @complete @ds
  Scenario: Do detail receiving process by providing input as URRN and footwear UPC [10 digit -only one value provided] , followed by quantity should be defaulted as '1' and perfect condition as 'Y' –  SINGLESHOE lock code in ITL
    ...
    Then the inventory transaction should be updated with lock code "SINGLESHOE" 
     ...
     @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit_only_one_value_provided]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_singleshoe_lock_code_in_itl @receiving @returns @boxed @complete @ds
  Scenario: Do detail receiving process by providing input as URRN and footwear UPC [10 digit -only one value provided] , followed by quantity should be defaulted as '1' and perfect condition as 'N' -  SINGLESHOE lock code in ITL
    ...
    @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_footwear_upc_[10_digit]_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y_should_prompt_to_provide_correct_upc_as_10_digit @receiving @returns @boxed @complete @ds
