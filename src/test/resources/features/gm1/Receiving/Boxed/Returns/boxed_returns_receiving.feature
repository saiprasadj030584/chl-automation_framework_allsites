...
Feature: Boxed - Returns - Receiving
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_unique_upc_with_multi_supplier_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_n_  @returns @receiving @returns @boxed @complete1 @ds
  ...
  @unique_boxed_receiving_returns_do_detail_receiving_process_by_providing_input_as_urrn_and_unique_upc_with_multi_supplier_followed_by_quantity_should_be_defaulted_as_1_and_perfect_condition_as_y @returns @receiving @returns @boxed @ds @complete1 
  Scenario: Do detail receiving process by providing input as URRN and unique UPC with multi supplier , followed by quantity should be defaulted as '1' and perfect condition as 'y' / 'N'
    Given the UPI and ASN should be in "Released" status for multi sourced SKU
