...
Feature: Boxed - Returns - Receiving
 ...
 @yes @boxed_receiving_returns_rms_verify_receiving_with_urrn_holds_different_dept_upc_and_mixed_stock @boxed @receiving @returns @review @check18
 ...
 @yes @boxed_receiving_returns_rms_validate_detail_receiving_urrn_and_verify_the_no_of_singles_per_upc_to_be_received_quantity_defaulted_as_1_and_verify_itl_screen_after_receiving @boxed @receiving @returns @review @check18
