...
Feature: Purchase order receiving
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_pallet_build_for_full_pallet_enter_n_in_full_pallet @boxed @direct_po @jenkinsdpr @receiving @complete @ds
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_pallet_build_for_full_pallet_enter_y_in_full_pallet @boxed @direct_po @jenkinsdpr @receiving @complete @ds
