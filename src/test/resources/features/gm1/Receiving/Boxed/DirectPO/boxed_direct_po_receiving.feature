...
Feature: Boxed - Direct PO - Receiving
  ...
  @jenkinsA @jenkinsch @unique_boxed_receiving_direct_po_receiving_without_lockcode @receiving @direct_po @boxed @complete @ds @maven_check_1 @putty_check @maven_check_2 @jenkinsbr 
  ...
  @jenkinsA @unique_boxed_receiving_direct_po_validate_automatic_document_closure_asn @receiving @direct_po @boxed @complete @ds @jenkinsbr
  ...
  @jenkinsA @jenkinsch @unique_boxed_receiving_direct_po_preadvice_qty_greater_than_upi_qty @po @complete @boxed @receiving @direct_po @ds 
  ...
  @jenkinsA  @jenkinsfly @unique_boxed_receiving_direct_po_preadvice_qty_less_than_upi_qty @boxed @receiving @direct_po @complete @ds 
  ...
  @jenkins_analysis @boxed @direct_po @receiving @complete @unique_boxed_receiving_direct_po_validate_receiving_process_for_boxed_when_two_putaway_group_involved @ds
  ...
  @jenkinsA @unique_boxed_receiving_direct_po_validate_the_urgent_delivery_po @boxed @direct_po @receiving @complete @ds @jenkinsbr
  Scenario: Validate the urgent delivery PO
    ...
    @jenkinsA @unique_boxed_receiving_direct_po_validate_manual_receipt @boxed @receiving @direct_po @complete @ds
