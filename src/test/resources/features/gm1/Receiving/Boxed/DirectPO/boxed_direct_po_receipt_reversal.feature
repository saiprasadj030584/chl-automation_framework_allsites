...
Feature: Purchase order receipt reversal
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_receipt_reversal_process_without_lock_code @boxed @direct_po @receiving @complete @ds @maven_check_1 @putty_check_1
