...
Feature: Boxed - Direct PO - Receiving with Lock code
  ...
  @jenkinsbr @jenkins_analysis @boxed_receiving_direct_po_receiving_with_lock_code_fwl @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkinsbr @jenkins_analysis @boxed_receiving_direct_po_receiving_with_lock_code_rework @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkinsbr @jenkins_analysis @boxed_receiving_direct_po_receiving_with_lock_code_qaftsfwl @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis @boxed_receiving_direct_po_receiving_with_lock_code_qacnifwl @boxed @receiving @direct_po @not_applciable @ds
  ...
  @jenkinsbr1 @jenkins_analysis @boxed_receiving_direct_po_receiving_with_lock_code_qapcfwl @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_qapcrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkinsbr @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_fwlrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkinsbr @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_qapcfwlrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_qacomfwlrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
