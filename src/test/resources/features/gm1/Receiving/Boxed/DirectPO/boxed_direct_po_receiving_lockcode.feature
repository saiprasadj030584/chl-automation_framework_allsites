...
Feature: Boxed - Direct PO - Receiving with Lock code
  ...
  @jenkins_analysis90 @boxed_receiving_direct_po_receiving_with_lock_code_qafts @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis90 @boxed_receiving_direct_po_receiving_with_lock_code_qacomp @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_fwlrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
  ...
  @jenkins_analysis @boxed_receiving_direct_po_validate_receiving_process_with_qapcfwlrw_lock_code @boxed @receiving @direct_po @complete @ds @jenkinsbrl
