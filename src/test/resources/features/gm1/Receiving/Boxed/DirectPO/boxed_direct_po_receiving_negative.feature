...
Feature: Boxed - Receiving - Direct PO - Negative
  ...
  I want to receive the articles that are damaged
   ...
   @jenkinsdpr2 @jenkins_analysis @boxed_receiving_direct_po_validate_damaged_on_receipt_from_supplier @direct_po @boxed @receiving @complete @ds @jenkins1
  Scenario: Validate damaged on receipt (From supplier) 
    ...
    @jenkinsdpr2 @jenkins_analysis @jenkinsdpr @boxed_receiving_direct_po_validate_not_received_asn @direct_po @boxed @receiving @complete @ds
