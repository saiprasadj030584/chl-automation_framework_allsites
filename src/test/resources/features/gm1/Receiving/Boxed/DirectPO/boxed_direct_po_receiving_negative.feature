...
Feature: Boxed - Receiving - Direct PO - Negative
  ...
  I want to receive the articles that are damaged
   ...
   @jenkinsA @boxed_receiving_direct_po_validate_damaged_on_receipt_from_supplier @direct_po @boxed @receiving @complete @ds @jenkins1
  Scenario: Validate damaged on receipt (From supplier) 
    ...
    @jenkinsA @boxed_receiving_direct_po_validate_not_received_asn @direct_po @boxed @receiving @complete @ds
