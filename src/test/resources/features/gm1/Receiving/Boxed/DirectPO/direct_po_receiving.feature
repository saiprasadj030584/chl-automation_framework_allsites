...
Feature: Purchase order receiving
  ...
  @boxed_direct_po_receiving_preadvice_qty_greater_than_upi_qty @po @complete @boxed @receiving @direct_po @ds
  ...
  @boxed @direct_po @receiving @complete @boxed_direct_po_receiving_articles_with_different_putaway_group @ds
