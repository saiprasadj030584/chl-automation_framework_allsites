...
Feature: Purchase order receiving
  ...
  @boxed_receiving_direct_po_validate_damaged_on_receipt_from_supplier @direct_po @boxed @receiving @complete @ds
  ...
  @boxed_receiving_direct_po_validate_not_received_asn @direct_po @boxed @receiving @complete @ds
