...
Feature: GOH - Manual Document Closure of ASN
  ...
  @jenkins_analysis @goh_receiving_direct_po_validate_manual_document_closure_asn @complete @goh @direct_po @receiving @ds @no_ds @jenkinssc
  Scenario: Validate manual document closure ASN
    Given I have an ASN Id of type "GOH" with delivery status as "In Progress"
