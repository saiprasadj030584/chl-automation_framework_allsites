...
Feature: GOH - Direct PO - Receiving
  ...
  Scenario: Validate manual receipt
    ...
    @jenkinsl @goh_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_lesser_than_the_upi_line_quantity @boxed @receiving @direct_po @complete @ds 
