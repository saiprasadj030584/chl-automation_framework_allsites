...
Feature: GOH - Direct PO - Receiving
  ...
  @jenkinsC @unique_goh_receiving_direct_po_validate_manual_receipt @goh @receiving @direct_po @complete @ds
  Scenario: Validate manual receipt
    ...
    @jenkinsC @unique_goh_receiving_direct_po_validate_automatic_document_closure_asn @receiving @direct_po @goh @complete @ds @jenkinsbr
   ...
   @jenkinsS  @jenkinsC @unique_goh_receiving_direct_po_validate_receipting_process_without_lock_code @receiving @direct_po @goh @complete @ds @maven_check_1 @putty_check @maven_check_2 @jenkinsbr 
  Scenario: Validate receipting process without lock code
    ...
    @jenkinsC @unique_goh_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_lesser_than_the_upi_line_quantity @boxed @receiving @direct_po @complete @ds 
  Scenario: Perform receiving when Pre advice line quantity is lesser than the UPI line quantity
   ...
   @jenkinsS @jenkinsC @unique_goh_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_greater_than_the_upi_line_quantity @po @complete @boxed @receiving @direct_po @ds 
  Scenario: Perform receiving when Pre advice line quantity is greater than the UPI line quantity
    ...
    @jenkinsC @unique_goh_receiving_direct_po_validate_the_urgent_delivery_po @goh @direct_po @receiving @complete @ds
