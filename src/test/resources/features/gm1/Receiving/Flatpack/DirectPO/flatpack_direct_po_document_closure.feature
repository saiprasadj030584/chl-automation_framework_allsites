...
Feature: Flatpack - Manual Document Closure of ASN
  ...
  @jenkins_analysis @flatpack_receiving_direct_po_validate_manual_document_closure_asn @complete @flatpack @direct_po @receiving @ds @no_ds @jenkinssc
  Scenario: Validate manual document closure ASN
    Given I have an ASN Id of type "Flatpack" with delivery status as "In Progress"
