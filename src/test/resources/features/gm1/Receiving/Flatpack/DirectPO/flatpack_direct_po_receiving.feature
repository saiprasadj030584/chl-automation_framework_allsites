...
Feature: Flatpack - Direct PO - Receiving
  ...
  Scenario: Validate manual receipt
    ...
    Then the po status should be displayed as "Complete"
     ...
     @jenkinsl @flatpack_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_less_than_the_upi_line_quantity @boxed @receiving @direct_po @complete @ds 
