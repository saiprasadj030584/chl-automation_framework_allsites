...
Feature: Flatpack - Direct PO - Receiving
  ...
  @jenkinsC @unique_flatpack_receiving_direct_po_validate_manual_receipt @flatpack @receiving @direct_po @complete @ds
  Scenario: Validate manual receipt
    ...
    @jenkinsC @unique_flatpack_receiving_direct_po_validate_receipting_process_without_lock_code @receiving @direct_po @boxed @complete @ds @maven_check_1 @putty_check @maven_check_2 @jenkinsbr 
  Scenario: Validate receipting process without lock code
   ...
   @jenkinsC @unique_flatpack_receiving_direct_po_validate_automatic_document_closure_asn @receiving @direct_po @flatpack @complete @ds @jenkinsbr
  ...
  @jenkinsC @unique_flatpack_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_lesser_than_the_upi_line_quantity @boxed @receiving @direct_po @complete @ds
  ...
  @jenkinsC @unique_flatpack_receiving_direct_po_perform_receiving_when_pre_advice_line_quantity_is_greater_than_the_upi_line_quantity @po @complete @boxed @receiving @direct_po @ds
  ...
  @jenkinsC @unique_flatpack_receiving_direct_po_validate_the_urgent_delivery_po @flatpack @direct_po @receiving @complete @ds
