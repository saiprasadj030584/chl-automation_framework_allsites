...
Feature: Receipt reversal
  ...
  @unique_hanging_receiving_direct_po_validate_receipt_reversal_process_without_lock_code @hanging @direct_po @receiving @complete
  ...
  @unique_hanging_receiving_direct_po_validate_receipt_reversal_process_with_qafts_lock_code @hanging @direct_po @receiving @complete
