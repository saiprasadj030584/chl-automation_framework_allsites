...
Feature: Boxed - Returns RMS - Receiving
  ...
  @returns @boxed @returns_rms @unique_boxed_returns_returns_rms_validate_the_returns_rms_normal_urn_single_line_item @ds @complete1 
  Scenario: Validate the Returns Non RMS - Normal URN - Single Line item
   ...
   @complete1 @returns @yes @boxed @returns_rms @unique_boxed_returns_returns_rms_validate_the_returns_rms_normal_urn_multiple_line_item @ds
