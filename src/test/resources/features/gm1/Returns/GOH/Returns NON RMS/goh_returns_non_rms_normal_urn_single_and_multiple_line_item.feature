@goh_returns_non_rms_returns
Feature: GOH - Returns Non RMS - Returns
  As a warehouse user
  I want to receive the articles

   @returns @goh @returns_non_rms @unique_goh_returns_returns_non_rms_validate_the_returns_non_rms_normal_urn_single_line_item @ds
