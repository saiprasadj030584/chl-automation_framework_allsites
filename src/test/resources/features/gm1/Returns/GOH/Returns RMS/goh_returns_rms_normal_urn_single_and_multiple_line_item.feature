@goh_returns_rms_returns
Feature: GOH - Returns RMS - Returns
  As a warehouse user
  I want to receive the returned articles

  @returns @goh @returns_rms @unique_goh_returns_returns_rms_validate_the_returns_rms_normal_urn_single_line_item @ds
