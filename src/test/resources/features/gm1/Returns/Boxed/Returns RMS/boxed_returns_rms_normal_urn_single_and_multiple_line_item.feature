@boxed_returns_rms_returns
Feature: Boxed - Returns RMS - Returns
  As a warehouse user
  I want to receive the returned articles

   @complete1 @returns @boxed @returns_rms @unique_boxed_returns_returns_rms_validate_the_returns_rms_normal_urn_single_line_item @ds 
  ...
  @returns @boxed @returns_rms @unique_boxed_returns_returns_rms_validate_the_returns_rms_normal_urn_multiple_line_item @ds @complete1 
