...
Feature: Boxed - Returns Non RMS - Multiple URN Single ASN Receiving
  As a warehouse user
  I want to receive the articles

 @yes @unique_boxed_returns_returns_non_rms_validate_the_returns_non_rms_normal_urn_asn_with_multiple_upi @returns @returns_rms @boxed @ds @complete
