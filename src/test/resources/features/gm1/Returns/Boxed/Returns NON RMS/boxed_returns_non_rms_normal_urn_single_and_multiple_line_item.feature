...
Feature: Boxed - Returns Non RMS - Returns
  ...
  I want to receive the articles
   ...
   @returns @boxed @returns_non_rms @unique_boxed_returns_returns_non_rms_validate_the_returns_non_rms_normal_urn_single_line_item @complete @ds
  ...
  @yes @returns @boxed @returns_non_rms @unique_boxed_returns_returns_non_rms_validate_the_returns_non_rms_normal_urn_multiple_line_item @complete @ds
