...
Feature: Hanging - Direct PO - Dock Scheduling
 ...
 @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_dock_schedule_asn @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds
 ...
 @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_trailer_type_information @complete @ds
 ...
 @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_assign_dock_door_for_each_trailer_to_unload_it @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_the_booking_can_be_deleted @complete @ds
  Scenario: Validate whether the Booking can be deleted
   ...
   @jenkinsD @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_can_be_made_to_complete_status @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete @ds
  ...
  @jenkinsB @pre_receiving @direct_po @hanging @unique_hanging_pre_receiving_direct_po_validate_whether_booking_can_be_moved_to_different_date @complete @ds
  ...
  @jenkinsB @hanging @pre_receiving @direct_po @unique_hanging_pre_receiving_direct_po_validate_whether_compliance_flag_can_be_uploaded_for_pre_advice_line @complete @ds
  ...
  @jenkinsB @hanging @pre_receiving @direct_po @unique_hanging_pre_receiving_direct_po_validate_the_product_attributes_are_available_for_the_receiving_process @complete @ds
