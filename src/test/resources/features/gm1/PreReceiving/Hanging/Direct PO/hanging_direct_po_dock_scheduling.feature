...
Feature: Dock Scheduling
  ...
  @pre_receiving @direct_po @hanging @hanging_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds
  ...
  @pre_receiving @direct_po @hanging @hanging_pre_receiving_direct_po_validate_whether_the_booking_can_be_deleted @complete @ds
  ...
  @pre_receiving @direct_po @hanging @hanging_pre_receiving_direct_po_validate_whether_booking_can_be_made_to_complete_status @complete @ds
  ...
  @hanging @pre_receiving @direct_po @hanging_pre_receiving_direct_po_validate_compliance_flag_uploaded @complete @ds
  ...
  @hanging @pre_receiving @direct_po @hanging_pre_receiving_direct_po_validate_the_product_attributes_are_available_for_the_receiving_process @complete @ds
