...
Feature: Dock Scheduling
  ...
  @jenkinsE @pre_receiving @returns_(non_rms) @unique_boxed_pre_receiving_returns_non_rms_validate_whether_asn_can_be_assigned_using_the_container_id @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_carrier_information @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_service_level_information @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_trailer_type_information @complete1 @ds
  ...
  @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_the_booking_can_be_deleted @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_made_to_complete_status @complete1 @ds
  ...
  @jenkinsE @stoke  @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete1 @ds
 ...
 @jenkinsE @stoke @pre_receiving @returns_(non_rms) @boxed @unique_boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_moved_to_different_date @complete1 @ds
