...
Feature: Dock Scheduling
  ...
  @pre_receiving @returns_(non_rms) @boxed_pre_receiving_returns_non_rms_validate_whether_asn_can_be_assigned_using_the_container_id @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_details_can_be_captured_trailer_type_information @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_the_booking_can_be_deleted @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_made_to_complete_status @complete @ds
  Scenario: Validate whether booking can be made to Complete status
    ...
    @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete @ds
  ...
  @pre_receiving @returns_(non_rms) @boxed @boxed_pre_receiving_returns_non_rms_validate_whether_booking_can_be_moved_to_different_date @complete @ds
