...
Feature: Boxed - Direct PO - Dock Scheduling
 ...
 @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_dock_schedule_asn @complete @ds @maven_check_1 @dock_check @allocation_check
  ...
  @jenkinsA @jenkinsgm @jenkins14 @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds @maven_check_1 @allocation_check
  Scenario: Validate whether Booking details can be captured - Carrier Information
    ...
    @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds @maven_check_1 @allocation_check
  ...
  @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_details_can_be_captured_trailer_type_information @complete @ds @maven_check_1 @allocation_check
  ...
  @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_the_booking_can_be_deleted @complete @ds @maven_check_1 @allocation_check
  ...
  @jenkinsD @jenkins_analysis @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete @ds @maven_check_1 @dock @allocation_check
  ...
  @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_can_be_made_to_complete_status @complete @ds @maven_check_1 @maven_check_2 @allocation_check
  ...
  @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete @ds
 ...
 @jenkinsA @jenkins_analysis @boxed @pre_receiving @direct_po @unique_boxed_pre_receiving_direct_po_validate_whether_compliance_flag_can_be_uploaded_for_pre_advice_line @complete @ds @maven_check_1 @allocation_check
 Scenario: Validate whether compliance flag can be uploaded for Pre advice line
  ...
  @jenkinsA @pre_receiving @direct_po @boxed @unique_boxed_pre_receiving_direct_po_assign_dock_door_for_each_trailer_to_unload_it @complete @ds
  ...
  @jenkinsA @unique_boxed_pre_receiving_direct_po_validate_whether_booking_can_be_moved_to_different_date @pre_receiving @direct_po @boxed @complete @ds @maven_check_1 @allocation_check
