...
Feature: Boxed - Direct PO - Dock Scheduling
  ...
  @jenkins_analysis @pre_receiving @direct_po @boxed @boxed_pre_receiving_direct_po_dock_schedule_asn @complete @ds @maven_check_1 @dock_check @allocation_check @santhosh_check
  ...
  @jenkins_analysis @boxed @pre_receiving @direct_po @boxed_pre_receiving_direct_po_validate_compliance_flag_uploaded @complete @ds @maven_check_1 @allocation_check
