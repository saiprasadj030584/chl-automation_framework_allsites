...
Feature: Dock Scheduling
  ...
  So that I can receive the same in the scheduled dock door
    ...
    @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_asn_can_be_assigned_using_the_container_id @complete @ds
 ...
 @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds
 ...
 @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds
 ...
 @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_details_can_be_captured_trailer_type_information @complete @ds
 ...
 @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_the_booking_can_be_deleted @complete @ds
 ...
 @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete @ds
  ...
  @jenkinsE @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_can_be_made_to_complete_status @complete @ds
 ...
 @jenkinsE  @pre_receiving @returns_rms @boxed @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete @ds
 ...
 @jenkinsE  @unique_boxed_pre_receiving_returns_rms_validate_whether_booking_can_be_moved_to_different_date @pre_receiving @returns_rms @boxed @complete @ds
