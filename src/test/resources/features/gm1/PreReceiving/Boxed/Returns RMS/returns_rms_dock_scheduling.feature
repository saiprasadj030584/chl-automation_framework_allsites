...
Feature: Dock Scheduling
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scheduling @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scheduling_carrier_info @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scheduling_service_level_info @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_dock_scheduling_trailer_type_info @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_delete_booking @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_move_booking_diff_time_sameday @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_change_status_of_booking_to_complete @complete @ds
  ...
  @pre_receiving @returns_(rms) @boxed @boxed_pre_receiving_returns_(rms)_change_status_of_booking_to_in_progress @complete @ds
  ...
  @boxed_pre_receiving_returns_(rms)_move_booking_diff_date @pre_receiving @returns_(rms) @boxed @complete @ds
