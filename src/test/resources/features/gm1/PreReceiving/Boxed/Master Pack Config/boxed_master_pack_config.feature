...
Feature: Boxed - Master pack Config
  ...
  @jenkinsA @pre_receiving @master_pack_config @boxed @boxed_pre_receiving_master_pack_config_validate_whether_pack_config_can_be_created_for_sku_s @complete @ds @no_ds @complete 
