...
Feature: Dock Scheduling
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_dock_schedule_carrier_information @complete @ds
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_dock_schedule_service_level_info @complete @ds
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_dock_schedule_trailer_type_info @complete @ds
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_assign_dock_door_for_trailer @complete @ds
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_move_booking_diff_time_sameday @complete @ds
  ...
  @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_delete_booking @complete @ds
  ...
  @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_change_status_of_booking_to_complete @complete @ds
  ...
  @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_change_status_of_booking_to_in_progress @complete @ds
  ...
  @boxed @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_validate_compliance_flag_uploaded @complete @ds
  ...
  @boxed_pre_receiving_fsv_po_move_booking_different_date @boxed @pre_receiving @fsv_po @complete @ds
