...
Feature: Dock Scheduling
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds @boxed_jenkins
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds @boxed_jenkins
  ...
  @pre_receiving @fsv_po @boxed @boxed_pre_receiving_fsv_po_validate_whether_booking_can_be_moved_to_different_time_on_the_same_day @complete @ds @boxed_jenkins
  ...
  @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_validate_whether_the_booking_can_be_deleted @complete @ds @boxed_jenkins
  ...
  @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_validate_whether_booking_can_be_made_to_complete_status @complete @ds @boxed_jenkins
  ...
  @boxed @pre_receiving @fsv_po @boxed_pre_receiving_fsv_po_validate_whether_compliance_flag_can_be_uploaded_for_pre_advice_line @complete @ds @boxed_jenkins
  ...
  @boxed_pre_receiving_fsv_po_validate_whether_booking_can_be_moved_to_different_date @boxed @pre_receiving @fsv_po @complete @ds @boxed_jenkins
