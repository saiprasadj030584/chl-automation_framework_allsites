...
Feature: Boxed - FSV PO - Dock Scheduling
  ...
  @jenkinsA @jenkinsfs @pre_receiving @fsv_po @boxed @unique_boxed_pre_receiving_fsv_po_dock_schedule @complete @ds @jenkinsfsv
  Scenario: Validate whether PO can be assigned using the Pre advice ID
   ...
   @jenkinsfs @jenkinsA @pre_receiving @fsv_po @boxed @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_details_can_be_captured_carrier_information @complete @ds 
  ...
  @jenkinsA @jenkinsfs @pre_receiving @fsv_po @boxed @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_details_can_be_captured_service_level_information @complete @ds 
  ...
  @jenkinsA @jenkinsfs @pre_receiving @fsv_po @boxed @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_details_can_be_captured_trailer_type_information @complete @ds  
  ...
  @jenkinsA @jenkinsfs @pre_receiving @fsv_po @boxed @unique_boxed_pre_receiving_fsv_po_assign_dock_door_for_each_trailer_to_unload_it @complete @ds  
  ...
  @jenkinsA @jenkinsfs  @jenkinsgm @pre_receiving @fsv_po @unique_boxed_pre_receiving_fsv_po_validate_whether_the_booking_can_be_deleted @complete @ds 
  ...
  @jenkinsA @jenkinsfs @pre_receiving @fsv_po @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_can_be_made_to_complete_status @complete @ds 
  ...
  @jenkinsA  @jenkinsfs @pre_receiving @fsv_po @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_status_can_be_updated_to_capture_the_arrival_time_scheduled_to_in_progress @complete @ds  
  ...
  @jenkinsA  @jenkinsfs @jenkinsgm @jenkins_analysis @boxed @pre_receiving @fsv_po @unique_boxed_pre_receiving_fsv_po_validate_whether_compliance_flag_can_be_uploaded_for_pre_advice_line @complete @ds 
  ...
  @jenkinsA @jenkinsfs @unique_boxed_pre_receiving_fsv_po_validate_whether_booking_can_be_moved_to_different_date @boxed @pre_receiving @fsv_po @complete @ds 
