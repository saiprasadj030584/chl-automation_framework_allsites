...
Feature: Inbound receiving IDT
  ...
  @boxed_inbound_receiving_idt_over_receiving_without_lockcode @idt @inbound_receiving @boxed @complete
  ...
  @boxed_inbound_receiving_idt_under_receiving_without_lockcode @idt @inbound_receiving @boxed @complete
