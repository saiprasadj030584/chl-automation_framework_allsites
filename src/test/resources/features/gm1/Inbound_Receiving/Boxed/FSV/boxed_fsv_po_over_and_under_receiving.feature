@boxed_fsv_po_inbound_receiving
Feature: Boxed - FSV PO - Inbound Receiving
  As a warehouse user
  I want to receive the sku from full service vendor supplier
  So that I can putaway the full service vendor purchase order

  @jenkinsA @unique_boxed_inbound_receiving_fsv_po_over_receiving @boxed @inbound_receiving @fsv_po @complete @ds @boxed_jenkins
  ...
  @jenkinsA @unique_boxed_inbound_receiving_fsv_po_under_receiving @boxed @inbound_receiving @fsv_po @complete @ds @boxed_jenkins
