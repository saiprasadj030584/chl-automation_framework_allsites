...
Feature: Inbound Receiving - Direct PO - Over & Under Receiving with Lock code
  ...
  @jenkinsS @jenkinsgo @jenkinsA @boxed_inbound_receiving_direct_po_over_receiving_with_lock_code @complete @ds @boxed @inbound_receiving @complete @ds @group_0
  Scenario: Validate Over receiving with lock code
   ...
   @jenkinsS @jenkinsgo @jenkinsA @boxed_inbound_receiving_direct_po_under_receiving_with_lock_code @complete @ds @boxed @inbound_receiving @complete @ds 
