...
@yes @unique_boxed_inbound_receiving_direct_po_multiple_po_receive_multiple_urn_single_trailer @boxed @inbound_receiving @direct_po @complete @ds
 ...
 @yes @unique_boxed_inbound_receiving_direct_po_single_po_and_multiple_urn_single_trailer @boxed @inbound_receiving @direct_po @recv @hangRev @complete
  Scenario: Single PO and mulitple URN ,single trailer
   ...
   @yes @unique_boxed_inbound_receiving_direct_po_multiple_trailer_multiple_urn_single_po @boxed @inbound_receiving @direct_po @recv @complete
  Scenario: Multiple trailer ,multiple URN,single PO
   ...
   @yes @unique_boxed_direct_po_receiving_adding_stock_to_asn_before_receiving @boxed @inbound_receiving @receiving @recv @complete
