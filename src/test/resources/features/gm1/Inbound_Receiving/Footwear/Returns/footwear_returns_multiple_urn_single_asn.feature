...
Feature: Footwear - Returns - Multiple URN Single ASN Receiving
 ...
 @yes @unique_footwear_inbound_receiving_returns_multiple_urn_and_single_asn @inbound_receiving @returns_rms @footwear @ds @complete
 ...
 @yes @returns @footware @returns_rms @unique_footwear_returns_returns_rms_validate_the_returns_rms_normal_urn_multiple_line_item @ds
  Scenario: Validate the Returns Non RMS - Normal URN - Multiple line item
    ...
    Then the inventory transaction should be updated for single upi
     ...
     @returns @footware @returns_rms @unique_footwear_returns_returns_rms_validate_the_returns_rms_normal_urn_single_line_item @ds
