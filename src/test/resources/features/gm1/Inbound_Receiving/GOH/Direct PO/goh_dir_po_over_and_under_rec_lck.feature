@goh_dir_po_over_and_under_rec_lck
Feature: goh - Direct PO - Inbound receiving with Lock code
  As a warehouse user
  I want to receive the articles
  So that I can putaway the purchase order

  @jenkinsC  @goh @inbound_receiving  @direct_po @unique_goh_inbound_receiving_direct_po_over_receiving_with_lock_code @complete @ds @group_0
  ...
  @jenkinsC @goh @inbound_receiving @direct_po @unique_goh_inbound_receiving_direct_po_under_receiving_with_lock_code @complete @ds  @group_0
