...
Feature: goh - Direct PO - Inbound receiving with Lock code
  ...
  So that I can putaway the purchase order
   ...
   @goh @inbound_receiving  @direct_po @unique_goh_inbound_receiving_direct_po_over_receiving_with_lock_code @complete @ds @group_0
  Scenario: Over receiving with lock code
   ...
   @goh @inbound_receiving @direct_po @unique_goh_inbound_receiving_direct_po_under_receiving_with_lock_code @complete @ds  @group_0
