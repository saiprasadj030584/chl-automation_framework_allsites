...
Feature: Feature: Hanging - Direct PO - Inbound receiving withoout lock code
  ...
  @jenkinsB @hanging @inbound_receiving @direct_po @unique_hanging_inbound_receiving_direct_po_over_receiving @complete @ds @group_0
  ...
  @jenkinsB @hanging @inbound_receiving @direct_po @unique_hanging_inbound_receiving_direct_po_under_receiving @complete @ds @group_1
