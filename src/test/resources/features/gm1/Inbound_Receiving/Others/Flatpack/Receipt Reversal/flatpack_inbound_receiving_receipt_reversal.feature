...
Feature: Purchase order receiving
  ...
  @flatpack @receipt_reversal @inbound_receiving @flatpack_inbound_receiving_receipt_reversal_perform_a_receipt_correction_stock_adjustment_function_after_putaway_of_receipt @complete @check17
  Scenario: Perform a receipt correction (stock adjustment function) after putaway of receipt
   ...
   When I choose existing relocate
    ...
    #Examples: 
      ...
      #|  1010007435 | 00050426003981847122 | 0000032219 | REC002   |   5649 | IE         |
