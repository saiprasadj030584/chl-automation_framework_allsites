...
Feature: Purchase order receiving
  ...
  So that I can putaway the purchase order
   ...
   @yes @goh @receipt_reversal @inbound_receiving @goh_inbound_receiving_receipt_reversal_perform_a_receipt_correction_stock_adjustment_function_after_putaway_of_receipt @complete @check17
