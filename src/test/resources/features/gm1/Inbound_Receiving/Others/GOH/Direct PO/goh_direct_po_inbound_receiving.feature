...
Feature: Inbound receiving
  ...
  @yes  @jenkinsC @boxed_inbound_receiving_direct_po_multiple_po_multiple_urn_single_asn @boxed @inbound_receiving @direct_po @complete @ds @recv 
  ...
  @yes @jenkinsC  @goh_inbound_receiving_direct_po_single_po_and_multiple_urn_single_trailer @goh @inbound_receiving @direct_po @recv @ds @complete
 ...
 @yes @jenkinsC  @goh_inbound_receiving_direct_po_multiple_trailer_multiple_urn_single_po @goh @inbound_receiving @direct_po @recv @ds @complete
  Scenario: Multiple trailer ,multiple URN,single PO
   ...
   @yes @jenkinsC @goh_inbound_receiving_direct_po_adding_stock_to_asn_before_receiving @goh @inbound_receiving @receiving @recv @ds @complete
