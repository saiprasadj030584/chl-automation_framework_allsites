@flatpack_inbound_receiving_idt_over_and_under_receiving
Feature: Inbound Receiving - IDT - Over & Under Receiving without Lock code
  As a warehouse user
  I want to receive the returned articles

      @jenkinsC @unique_flatpack_inbound_receiving_idt_over_receiving @idt @inbound_receiving @flatpack @complete @ds @maven_check_1 @jenkinsfly
  Scenario: Validate Over receiving
   ...
   @jenkinsC @unique_flatpack_inbound_receiving_idt_under_receiving @idt @inbound_receiving @flatpack @complete @ds @maven_check_1 @jenkinsfly
