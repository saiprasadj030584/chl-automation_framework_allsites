...
Feature: Outbound order
 ...
 @yes @outbound_despatch @flatpack @retail @unique_flatpack_outbound_order_till_despatch_retail_type_order_split_shipment_and_multiple_vehicle_single_order @ds
