...
Feature: Outbound order
  ...
  @outbound_despatch @boxed @idt @unique_boxed_outbound_order_till_despatch_idt_order_split_shipment_and_multiple_vehicle_single_order @ds
  Scenario: Split shipment and multiple vehicle,single order
    ...
    And I perform split picking for boxed non retail
