...
Feature: Hanging - Inventory update
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_lock_the_stock_from_unlock @complete @ds @no_ds
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_update_expiry_date @complete @ds @no_ds
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_origin_update @complete @ds @no_ds
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_update_condition_code @complete @ds @no_ds
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_pallet_type_update @complete @ds @no_ds
  ...
  @jenkins_analysis @hanging @stock_adjustment @inventory_update @hanging_stock_adjustment_inventory_update_pack_config_update @complete @ds @no_ds
