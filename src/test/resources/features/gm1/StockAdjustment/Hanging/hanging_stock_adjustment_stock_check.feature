...
Feature: Hanging - Stock Check Positive Proof
  ...
  @jenkinsD @hanging @stock_check @stock_adjustment @unique_hanging_stock_adjustment_stock_check_positive_proof_of_stock_check @complete @ds @jenkins1 @no_ds @jenkinssc
