...
Feature: Hanging - Stock Check
  As a warehouse user
  I want to validate stock in inventory

  @boxed @stock_check @stock_adjustment @hanging_stock_adjustment_stock_check_positive_proof_of_stock_check @complete @ds @jenkins1 @no_ds
