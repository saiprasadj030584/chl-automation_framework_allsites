...
Feature: Stock adjustments
  ...
  I want to adjust the stock in inventory
   ...
   @complete1 @stock_adjustment @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_greater_quantity_than_the_expected_volume_for_a_product_within_the_urrn_and_has_a_movement_label_over_receipt @stock_adj_check
  ...
  @complete1 @stock_adjustment1 @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_greater_quantity_than_the_expected_volume_for_a_product_within_the_urrn_and_does_not_have_a_movement_label_over_receipt @stock_adj_check
  Scenario Outline: Verify reason code available for 'Store has sent greater quantity than the expected volume for a product within the URRN and has a movement label.'
    Given the UPI and ASN should be in "Released" status for adjustment
  ...
  @complete1 @stock_adjustment @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_a_product_not_listed_for_the_urrn_and_has_a_movement_label_unexpected @stock_adj_check 
 ...
 @complete1  @stock_adjustment @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_a_product_not_listed_for_the_urrn_and_does_not_have_a_movement_label_unexpected @stock_adj_check 
 ...
 @complete1  @stock_adjustment @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_stock_without_any_urrn_but_has_a_movement_label_non_adviced @stock_adj_check @complete1 
 ...
 @complete1  @stock_adjustment @returns @boxed @complete @ds @unique_boxed_stock_adjustment_returns_verify_reason_code_available_for_store_has_sent_stock_without_any_urrn_or_movement_label_non_adviced @stock_adj_check @complete1 
