...
Feature: Boxed - Inventory update
  ...
  @jenkinsA @jenkinsrun @boxed @stock_adjustment @inventory_update @unique_boxed_stock_adjustment_inventory_update_unlock_the_stock_from_lock @complete @ds @jenkins1 @no_ds @group_1
