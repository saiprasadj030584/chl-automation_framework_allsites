...
Feature: Boxed - Inventory update
  ...
  @jenkinsA @jenkinsch @boxed @stock_adjustment @inventory_update @boxed_stock_adjustment_inventory_update_unlock_the_stock_from_lock @complete @ds @jenkins1 @no_ds @group_1
