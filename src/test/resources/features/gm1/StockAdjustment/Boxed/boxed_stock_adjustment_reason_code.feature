...
Feature: Boxed - Stock adjustments with Reason Code
  ...
  @jenkinsA @jenkinsgm @stock_adjustment @boxed @unique_boxed_stock_adjustment_stock_adjustment_reason_code_dirty @complete @ds @jenkins1 @no_ds
  ...
  @jenkinsA @jenkinsgm @jenkinsgm1 @stock_adjustment @boxed @unique_boxed_stock_adjustment_stock_adjustment_reason_code_dmit @complete @ds @jenkins1 @no_ds
