@flatpack_inventory_update
Feature: Flatpack - Inventory update
  As a warehouse user
  I want to update the stock in inventory for the required status

  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_unlock_the_stock_from_lock @complete @ds @jenkins1 @no_ds
  Scenario Outline: Unlock the stock from Lock
    Given I have a tag in inventory with "<LockStatus>" status for "Flatpack"
  ...
  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_lock_the_stock_from_unlock @complete @ds @no_ds
  ...
  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_origin_update @complete @ds @jenkins1 @no_ds
  Scenario Outline: Origin update
    #Given I have a tag in inventory with origin "<Origin>"
    Given I have a tag in inventory with origin "<Origin>" for "Flatpack"
    When I navigate to inventory update page
  ...
  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_update_condition_code @complete @ds @jenkins1 @no_ds
  Scenario Outline: Update condition code
    #Given I have a tag in inventory with condition "<Condition>"
    Given I have a tag in inventory with condition "<Condition>" for "Flatpack"
    When I navigate to inventory update page
  ...
  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_pallet_type_update @complete @ds @jenkins1 @no_ds
  Scenario Outline: Pallet type update
    #Given I have a tag in inventory with pallet type as "<PalletType>"
    Given I have a tag in inventory with pallet type as "<PalletType>" for "Flatpack"
    When I navigate to inventory update page
  ...
  @jenkinsC @flatpack @stock_adjustment @inventory_update @unique_flatpack_stock_adjustment_inventory_update_pack_config_update @complete @ds @jenkins1 @no_ds
  Scenario: Pack config update
    #Given I have a sku in inventory with more than one pack config
    Given I have a sku in inventory with more than one pack config for "Flatpack"
    When I navigate to inventory update page
