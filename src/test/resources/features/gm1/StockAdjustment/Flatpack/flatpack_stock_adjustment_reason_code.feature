...
Feature: Flatpack - Stock adjustments with Reason Code
  ...
  @flatpack @jenkinsgm @jenkins14 @stock_adjustment @stock_adjustment_reason_code @unique_flatpack_stock_adjustment_stock_adjustment_reason_code_do_stock_adjustment_by_selecting_reason_code_as_found_ @complete @ds @no_ds @jenkinsC
  ...
  @flatpack @jenkinsgm @jenkins14 @stock_adjustment @stock_adjustment_reason_code @unique_flatpack_stock_adjustment_stock_adjustment_reason_code_do_stock_adjustment_by_selecting_reason_code_as_lost_ @complete @ds @no_ds @jenkinsC
